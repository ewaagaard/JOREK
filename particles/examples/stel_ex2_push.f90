!> Boris push test for W7-A stellarator: Gaussian blob of W impurities,
...
!> Derived from stel_ex2.f90; only changes: with_push=.true., with_v_thermal_init=.true.
program stel_ex2_push
use data_structure
